...
def calculate_recall(
    ...
    """
    found = 0
    num_queries = result_set_indices.shape[0]
    
    # Handle single query case in truth set
    if len(truth_set_indices.shape) == 1 and num_queries == 1:
        truth_set_indices = truth_set_indices.reshape(1, -1)
    ...
    return found / (num_queries * recall_at)
